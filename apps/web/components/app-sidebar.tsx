...
// Personal branding and sample data
const data = {
  user: {
    name: 'Mayank Bharati',
    email: 'mayank@example.com',
    avatar: 'https://github.com/mayankbharati.png',
  },
  navMain: [
    {
      title: 'All Chats',
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" asChild className="md:h-8 md:p-0">
                <a href="#">
                  <div className="bg-gradient-to-br from-primary via-purple-500 to-pink-500 text-white flex aspect-square size-8 items-center justify-center rounded-lg pulse-glow">
                    <Sparkles className="size-4" />
                  </div>
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    <span className="truncate font-medium gradient-text">AI Nexus</span>
                    <span className="truncate text-xs text-muted-foreground">by Mayank Bharati</span>
                  </div>
                </a>
              </SidebarMenuButton>
            </SidebarMenuItem>
